...
import com.project.utility.MobileUtility;
...
//		GeneralUtility.Sleep(3);
	...
	public void catchExceptions(ITestResult result) throws Exception {
		...
		if (!result.isSuccess()) {
				...
				String userDirector = MobileUtility.getUserDir(System.getProperty("user.dir")) + "/";
				String TimeStamp = MobileUtility.TimeStamp();
	...
	// Click web element using JavaScritp (js)
	public boolean clickIE(WebElement we) throws Exception {
		boolean result = false;
		int attempts = 0;
		while (attempts < 10) {
			...
			MobileUtility.Sleep(10);
//			System.out.println("url: " + driver.getCurrentUrl());
//			driver.get(driver.getCurrentUrl());
			System.out.println("finish click ie");
			break;
		}
		attempts++;
